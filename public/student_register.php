            ...
            <div class="structure">
                <div id="main" class="main on">
                    ...
                    <form id="formRegistrarEstudiante" class="container_register">
                        ...
                        <div>
                            <label for="estudiantes_depto_exp">Departamento</label>
                            <input type="text" id="estudiantes_depto_exp" name="fecha_nacimiento" required>
                        </div>
                        <div>
                            <label for="estudiantes_ciudad_exp">Ciudad de expedición</label>
                            <input type="text" id="estudiantes_ciudad_exp" name="fecha_nacimiento" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="estudiantes" name="address" required>
                        </div>
                        <div>
