$(document).ready(function () {
    ...
    var tabla = $('#myTable').DataTable({
        "ajax": {
            "url": "/src/controllers/students/fetch_students.php",
            "type": "POST",
            "datatype": 'json',
                        ...
                        <form id="edit-form">
                            <div class="inputs">
                                ...
                                <select name="estudiantes_tipo_documento" id="estudiantes_tipo_documento" required>
                                    <option value="ti" ${rowData.sigla === 'ti' ? 'selected' : ''}>Tarjeta de identidad</option>
                                    <option value="cc" ${rowData.sigla === 'cc' ? 'selected' : ''}>Cedula de ciudadanía</option>
                                    <option value="ce" ${rowData.sigla === 'ce' ? 'selected' : ''}>Cédula de extranjería</option>
                                    <option value="co" ${rowData.sigla === 'co' ? 'selected' : ''}>Código</option>
                                </select>
                            </div>
                            <div class="inputs">
                                <label for="estudiantes_no_documento">Nro documento</label>
                                <input type="text" id="estudiantes_no_documento" name="estudiantes_no_documento" value="${rowData.nroDocumento}" required>
                                <input type="hidden" id="estudiantes_no_documento_hidden" name="idHidden"  value="${rowData.nroDocumento}">
                            </div>
                            <div class="inputs">
                                <label for="estudiantes_nombre">Nombre</label>
                                <input type="text" id="estudiantes_nombre" name="estudiantes_nombre" value="${rowData.nombre}">
                            </div>
                            <div class="inputs">
                                <label for="estudiantes_apellidos">Apellidos</label>
                                <input type="text" id="estudiantes_apellidos" name="estudiantes_apellidos" value="${rowData.apellido}">
                            </div>
                            <div class="inputs">
                                <label for="estudiantes_fecha_nacimiento">Fecha de nacimiento</label>
                                <input type="date" id="estudiantes_fecha_nacimiento" value="${rowData.fechaNacimiento}">
                            </div>
                            <div class="inputs">
                                <label for="estudiantes_correo">Correo electrónico</label>
                                <input type="text" id="estudiantes_correo" name="estudiantes_correo" value="${rowData.correo}">
                            </div>
                            <div class="inputs">
                                <label for="estudiantes_telefono">Teléfono</label>
                                <input type="number" id="estudiantes_telefono" name="estudiantes_telefono" value="${rowData.telefono}">
                            </div>
                            <div class="inputs">
                                <label for="estudiantes_genero">Género</label>
                                <select name="estudiantes_genero" id="estudiantes_genero" required>
                                    <option value="Nulo" ${rowData.genero === 'Nulo' ? 'selected' : ''}>Nulo</option>
                                    <option value="Masculino" ${rowData.genero === 'Masculino' ? 'selected' : ''}>Masculino</option>
                                    <option value="Femenino" ${rowData.genero === 'Femenino' ? 'selected' : ''}>Femenino</option>
                                </select>
                            </div>
                            <div class="inputs">
                                <label for="estudiantes_estado">Estado</label>
                                <select name="estudiantes_estado" id="estudiantes_estado" required>
                                    <option value="Activo" ${rowData.estado === 'Activo' ? 'selected' : ''}>Activo</option>
                                    <option value="Inactivo" ${rowData.estado === 'Inactivo' ? 'selected' : ''}>Inactivo</option>
                                    <option value="Egresado" ${rowData.estado === 'Egresado' ? 'selected' : ''}>Egresado</option>
                                    <option value="Inhabilitado" ${rowData.estado === 'Inhabilitado' ? 'selected' : ''}>Inhabilitado</option>
                                </select>
                            </div>
                            <div class="inputs">
                                <label for="estudiantes_direccion">Dirección</label>
                                <input type="text" id="estudiantes_direccion" value="${rowData.direccion}">
                            </div>
                            <div class="inputs">
                                <label for="estudiantes_observaciones">Observaciones</label>
                                <textarea id="estudiantes_observaciones">${rowData.observaciones}</textarea>
                            </div>
                            <div class="inputs">
